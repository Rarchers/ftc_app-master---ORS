package org.firstinspires.ftc.robotcontroller.filters.ar;
...
public final class ImageDetectionFilter implements Filter {
    ...
    public final Mat mSceneCorners = new Mat(0, 0, CvType.CV_32FC2);
    ...
    private void draw(final Mat src, final Mat dst) {
        ...
        Vision.getInstance().find = true;
        vision.setCameraViewSize(dst.width(), dst.height());
        vision.setTargetFromFilter(mSceneCorners);
